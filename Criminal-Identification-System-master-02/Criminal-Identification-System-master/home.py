...
pages = []
for i in range(4):
    pages.append(tk.Frame(root, bg="#000000"))
...
def register(entries, required, menu_var):
    ...
    # Setting Directory
    path = os.path.join('C:/Users/user/Downloads/Criminal-Identification-System-master-02/Criminal-Identification-System-master/face_samples', 'C:/Users/user/Downloads/Criminal-Identification-System-master-02/Criminal-Identification-System-master/face_samples/temp_criminal')
...
######################################## Home Page ####################################
tk.Label(pages[0], text="NO WAY TO ESCAPE !!!", fg="white", bg="#000000",
      font="Arial 35 bold", pady=40).pack()

logo = tk.PhotoImage(file = "logo.png")
tk.Label(pages[0], image=logo, bg="#000000").pack()

btn_frame = tk.Frame(pages[0], bg="#000000", pady=10)
btn_frame.pack()
